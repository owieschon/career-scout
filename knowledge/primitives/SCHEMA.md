...
Atomic, grounded, tagged units of the operator persona's profile. The prep agent
SELECTS a role-specific subset and the composition layer (positioning-spine =
composition rules) weaves them into coherent, non-recycled materials. Replaces
prose masters as the *basis material*; the spine governs *how* selected primitives
are composed.
